...
export default function MusicPlayer() {
  ...
  useEffect(() => {
    ...
    const handleError = () => {
      ...
      setAudioError("Tidak dapat memuat file audio")
      setIsPlaying(false)
    }
      ...
      if (playPromise !== undefined) {
        playPromise
          ...
          .catch((error) => {
            ...
            setAudioError("Tidak dapat memutar audio. Coba klik lagi.")
            setIsPlaying(false)
          })
      }
    }
      ...
      {isExpanded && (
        <div className="bg-black/80 backdrop-blur-md border border-cyan-500/50 rounded-md p-3 shadow-[0_0_15px_rgba(0,255,255,0.2)] relative overflow-hidden">
          ...
          <div className="mb-3 pr-6">
            ...
            <p className="text-gray-400 text-xs truncate">Musik Latar</p>
          </div>
          ...
          <div className="flex items-center justify-between">
            ...
            <button
              onClick={toggleMute}
              className="text-gray-400 hover:text-cyan-400 transition-colors"
              aria-label={isMuted ? "Suarakan" : "Bisukan"}
            >
