      ...
      <div className="container mx-auto px-4" ref={ref}>
        ...
        >
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div>
              ...
              <p className="mb-4 max-w-md text-gray-300">
                Sistem Informasi student at Nusa Putra University with skills in programming, data analysis,
          ...
          <div className="border-t border-cyan-500/20 mt-8 pt-8 text-center">
            <p className="text-gray-400">&copy; {new Date().getFullYear()} M Z Haikal Hamdani. All rights reserved.</p>
          </div>
        </motion.div>
      </div>
    </footer>
