...
export default function Statistics() {
  ...
  const statsData = [
    { value: 15, title: "Proyek Selesai", icon: <Code className="h-6 w-6" /> },
    { value: 3, title: "Tahun Pengalaman", icon: <Clock className="h-6 w-6" /> },
    { value: 10, title: "Klien Puas", icon: <Users className="h-6 w-6" /> },
    { value: 5, title: "Sertifikasi", icon: <Award className="h-6 w-6" /> },
  ]

  const skillsData = [
    { skill: "Pengembangan Web", percentage: 90 },
    { skill: "Analisis Data", percentage: 85 },
    { skill: "Keamanan Siber", percentage: 75 },
    { skill: "Modifikasi Game", percentage: 80 },
    { skill: "Desain UI/UX", percentage: 70 },
  ]
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="max-w-6xl mx-auto" ref={ref}>
          ...
          >
            ...
            <Card className="bg-black/50 border border-cyan-500/30 backdrop-blur-sm hover:shadow-[0_0_15px_rgba(0,255,255,0.15)] transition-all duration-500">
              <CardContent className="p-6">
                <h3 className="text-xl font-bold mb-6 text-white">Ringkasan Profesional</h3>
                <div className="space-y-4 text-gray-300">
                  <p>
                    Sebagai mahasiswa Sistem Informasi yang berdedikasi, saya telah secara konsisten menunjukkan
                    kemampuan teknis yang kuat di berbagai bidang.
                  </p>
                  <p>
                    Portfolio saya menampilkan berbagai keterampilan dari pemrograman hingga keamanan siber, dengan
                    rekam jejak yang terbukti dalam memberikan hasil berkualitas tinggi.
                  </p>
                  <p>
                    Saya bangga selalu mengikuti perkembangan teknologi terbaru dan terus memperluas basis pengetahuan
                    saya untuk tetap berada di garis depan industri teknologi.
                  </p>
                  <div className="pt-4">
